                ...
                ->children()
                    ...
                    ->info('Dropbox using official dropbox sdk API')
                        ->children()
                            ...
                            ->scalarNode('remote_month_path')->isRequired()->end()
                            ->scalarNode('remote_files_count')->isRequired()->end()
                            ->scalarNode('remote_month_count')->isRequired()->end()
                            ->scalarNode('file_prefix')->isRequired()->end()
                        ->end()
                    ->end()
