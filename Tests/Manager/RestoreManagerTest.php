...
class RestoreManagerTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function shouldRestoreDatabase()
    {
        ...
        $databaseManagerMock = $this->createMock(DatabaseManager::class)->disableOriginalConstructor()->getMock();
        $databaseManagerMock->expects($this->once())->method('restore');
        $clientManagerMock = $this->createMock(ClientManager::class)->disableOriginalConstructor()->getMock();
        $clientManagerMock->expects($this->once())->method('download')->willReturn($fileMock);
        $processorManagerMock = $this->createMock(ProcessorManager::class)->disableOriginalConstructor()->getMock();
